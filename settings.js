...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '' : process.env.SESSION_ID,'VAJIRA-MD=3Rt2DSzZ#Zgri3QGmCoinOojZdi19wuIuhy9GkOX7VbStDrXqL0Y'
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '' : process.env.OWNER_NUMBER, '258876666770'
